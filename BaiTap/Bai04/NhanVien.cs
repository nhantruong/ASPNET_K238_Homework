...
{
    #region Buổi 5 - Tạo Class ban đầu
    ...
    { 
        ...
        public virtual double TinhLuong() // Cho phép Class con Ghi đè (OverWrite) method này
        {
            double kq = 0;
        ...
        public virtual double TinhThuong() //Class con dc phép overwrite
        {
            double kq = 0;
            kq = ThamNien * 500000;
            return kq;
    ...
    #region Buổi 6- Constructors - Phương thức khởi tạo
        ...
        public NhanVien(string Maso, string HoTen, DateTime Ngaysinh,DateTime NgayVaoLam, double HeSoLuong, Phai GioiTinh)
        {
            this.Maso = Maso;
            this.Hoten = Hoten;
        ...
        protected int _SoNgayVang;  //Field Số ngày Vắng
                                    //Cho phép Class con được truy xuất vào giá trị của Field này
        ...
        protected static int _DinhMucVang = 3;//Định mức vắng
        ...
        /// Khởi tạo đối tượng Nhân viên có tham số (Mã số, Họ tên, ngày sinh...)
        /// </summary>
        public NhanVien(string Maso, string HoTen, DateTime Ngaysinh, DateTime NgayVaoLam, double HeSoLuong, Phai GioiTinh,int SoNgayVang)
        {
            this.Maso = Maso;
            this.Hoten = Hoten;
            this.Ngaysinh = Ngaysinh;
