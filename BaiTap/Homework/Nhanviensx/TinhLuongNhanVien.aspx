            ...
            <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
                <asp:View ID="View1" runat="server">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-right">
                            ...
                            <asp:RadioButton ID="rdbNVVP" runat="server" GroupName="LoaiNhanVien" OnCheckedChanged="rdbNVVP_CheckedChanged" Text="Văn phòng" />
                ...
                <asp:View ID="View2" runat="server">
                    ...
                    <div style="padding: 10px 20px;">
                        ...
                        <p class="text-right" style="padding: 10px 0px; border-top: 1px solid #c9c4c4">
